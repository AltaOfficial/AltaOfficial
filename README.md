...
| **Twitter DM Advertiser — Backend Heavy** | **AI Tutor Bot — ChatGPT API Usage** |
|:---:|:---:|
...
| **All-in-1 Gym App — React Native/Expo Usage** | **Monopoly in MATLAB — Springboot/websockets Usage** |
|:---:|:---:|
